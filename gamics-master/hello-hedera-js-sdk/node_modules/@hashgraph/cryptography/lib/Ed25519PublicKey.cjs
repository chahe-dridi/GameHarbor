...
class Ed25519PublicKey extends _Key.default {
  ...
  static fromBytesDer(data) {
    const asn = _nodeForge.default.asn1.fromDer(new _nodeForge.default.util.ByteStringBuffer(data));

    /** * @type {Uint8Array} */
    let publicKey;
    try {
      publicKey = _nodeForge.default.pki.ed25519.publicKeyFromAsn1(asn);
    } catch (error) {
      const message =
      ...
      /** @type {Error} */
      error.message : "";
      throw new _BadKeyError.default(`cannot decode ED25519 public key data from DER format: ${message}`);
    }
