...
class TransactionRecordQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const record = /** @type {HashgraphProto.proto.ITransactionGetRecordQuery} */
  ...
  _shouldRetry(request, response) {
    ...
    const transactionGetRecord = /** @type {HashgraphProto.proto.ITransactionGetRecordResponse} */
  ...
  _mapStatusError(request, response) {
    ...
    const receipt = /** @type {HashgraphProto.proto.ITransactionReceipt} */
    record.receipt;
    const receiptStatusError = /** @type {HashgraphProto.proto.ResponseCodeEnum} */
    receipt.status;
  ...
  _mapResponse(response, nodeAccountId, request) {
    const record = /** @type {HashgraphProto.proto.ITransactionGetRecordResponse} */
    response.transactionGetRecord;
