...
class TransactionRecord {
  ...
  _toProtobuf() {
    ...
    const duplicates = this.duplicates.map(record => ( /** @type {HashgraphProto.proto.ITransactionRecord} */
    record._toProtobuf().transactionRecord));
    const children = this.children.map(record => ( /** @type {HashgraphProto.proto.ITransactionRecord} */
    record._toProtobuf().transactionRecord));
    return {
  ...
  static _fromProtobuf(response) {
    ...
    return new TransactionRecord({
      receipt: _TransactionReceipt.default._fromProtobuf({
        receipt: ( /** @type {HashgraphProto.proto.ITransactionReceipt} */
        record.receipt)
      }),
      transactionHash: record.transactionHash != null ? record.transactionHash : new Uint8Array(),
      consensusTimestamp: _Timestamp.default._fromProtobuf( /** @type {HashgraphProto.proto.ITimestamp} */
      record.consensusTimestamp),
      transactionId: _TransactionId.default._fromProtobuf( /** @type {HashgraphProto.proto.ITransactionID} */
