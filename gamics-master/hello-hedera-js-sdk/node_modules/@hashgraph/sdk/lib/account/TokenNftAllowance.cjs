...
class TokenNftAllowance {
  ...
  static _fromProtobuf(allowance) {
    ...
    return new TokenNftAllowance({
      tokenId: _TokenId.default._fromProtobuf( /** @type {HashgraphProto.proto.ITokenID} */
      allowance.tokenId),
      spenderAccountId: allowance.spender != null ? _AccountId.default._fromProtobuf( /** @type {HashgraphProto.proto.IAccountID} */
      allowance.spender) : null,
      ownerAccountId: allowance.owner != null ? _AccountId.default._fromProtobuf( /**@type {HashgraphProto.proto.IAccountID}*/
      ...
      allSerials,
      delegatingSpender: allowance.delegatingSpender != null ? _AccountId.default._fromProtobuf( /**@type {HashgraphProto.proto.IAccountID}*/
  ...
  static _fromGrantedProtobuf(allowance, ownerAccountId) {
    return new TokenNftAllowance({
      tokenId: _TokenId.default._fromProtobuf( /** @type {HashgraphProto.proto.ITokenID} */
      allowance.tokenId),
      spenderAccountId: _AccountId.default._fromProtobuf( /** @type {HashgraphProto.proto.IAccountID} */
      allowance.spender),
      ownerAccountId,
      serialNumbers: [],
      allSerials: null,
