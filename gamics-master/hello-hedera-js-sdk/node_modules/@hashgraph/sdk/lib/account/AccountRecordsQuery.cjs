...
class AccountRecordsQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const records = /** @type {HashgraphProto.proto.ICryptoGetAccountRecordsQuery} */
  ...
  _mapResponseHeader(response) {
    const cryptoGetAccountRecords = /** @type {HashgraphProto.proto.ICryptoGetAccountRecordsResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const cryptoGetAccountRecords = /** @type {HashgraphProto.proto.ICryptoGetAccountRecordsResponse} */
    response.cryptoGetAccountRecords;
    const records = /** @type {HashgraphProto.proto.ITransactionRecord[]} */
