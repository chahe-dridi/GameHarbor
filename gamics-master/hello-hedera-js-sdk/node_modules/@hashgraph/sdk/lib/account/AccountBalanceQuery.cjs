...
class AccountBalanceQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const balance = /** @type {HashgraphProto.proto.ICryptoGetAccountBalanceQuery} */
  ...
  _mapResponseHeader(response) {
    const cryptogetAccountBalance = /** @type {HashgraphProto.proto.ICryptoGetAccountBalanceResponse} */
