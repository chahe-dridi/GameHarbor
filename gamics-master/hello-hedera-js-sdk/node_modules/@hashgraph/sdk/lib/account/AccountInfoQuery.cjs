...
class AccountInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const cryptoGetInfo = /** @type {HashgraphProto.proto.ICryptoGetInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const info = /** @type {HashgraphProto.proto.ICryptoGetInfoResponse} */
    response.cryptoGetInfo;
    return Promise.resolve(_AccountInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.CryptoGetInfoResponse.IAccountInfo} */
    info.accountInfo));
  }
