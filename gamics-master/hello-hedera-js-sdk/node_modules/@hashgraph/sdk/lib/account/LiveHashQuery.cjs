...
class LiveHashQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const hash = /** @type {HashgraphProto.proto.ICryptoGetLiveHashQuery} */
  ...
  _mapResponseHeader(response) {
    const cryptoGetLiveHash = /** @type {HashgraphProto.proto.ICryptoGetLiveHashResponse} */
  ...
  _mapResponse(response) {
    const hashes = /** @type {HashgraphProto.proto.ICryptoGetLiveHashResponse} */
    response.cryptoGetLiveHash;
    return Promise.resolve(_LiveHash.default._fromProtobuf( /** @type {HashgraphProto.proto.ILiveHash} */hashes.liveHash));
  }
