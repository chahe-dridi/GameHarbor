...
class TokenInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const tokenGetInfo = /** @type {HashgraphProto.proto.ITokenGetInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    ...
    response.tokenGetInfo;
    return Promise.resolve(_TokenInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.ITokenInfo} */info.tokenInfo));
  }
