...
class TokenNftInfoQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    if (query.tokenGetNftInfo != null) {
      const info = /** @type {HashgraphProto.proto.ITokenGetNftInfoQuery} */
      ...
      const info = /** @type {HashgraphProto.proto.ITokenGetAccountNftInfosQuery} */
      ...
      const info = /** @type {HashgraphProto.proto.ITokenGetNftInfosQuery} */
  ...
  _mapResponseHeader(response) {
    const infos = /** @type {HashgraphProto.proto.ITokenGetNftInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const nfts = [( /** @type {HashgraphProto.proto.ITokenNftInfo} */

    /** @type {HashgraphProto.proto.ITokenGetNftInfoResponse} */response.tokenGetNftInfo.nft)];
    return Promise.resolve(nfts.map(nft => _TokenNftInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.ITokenNftInfo} */nft)));
  }
