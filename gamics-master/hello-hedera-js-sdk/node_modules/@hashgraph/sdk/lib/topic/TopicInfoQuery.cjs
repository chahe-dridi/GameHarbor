...
class TopicInfoQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const info = /** @type {HashgraphProto.proto.IConsensusGetTopicInfoQuery} */
  ...
  _mapResponseHeader(response) {
    const consensusGetTopicInfo = /** @type {HashgraphProto.proto.IConsensusGetTopicInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    return Promise.resolve(_TopicInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.IConsensusGetTopicInfoResponse} */
    response.consensusGetTopicInfo));
  }
