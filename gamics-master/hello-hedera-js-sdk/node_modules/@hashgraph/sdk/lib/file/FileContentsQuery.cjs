...
class FileContentsQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const contents = /** @type {HashgraphProto.proto.IFileGetContentsQuery} */
  ...
  _mapResponseHeader(response) {
    const fileGetContents = /** @type {HashgraphProto.proto.IFileGetContentsResponse} */
  ...
  _mapResponse(response) {
    const fileContentsResponse = /** @type {HashgraphProto.proto.IFileGetContentsResponse} */
    response.fileGetContents;
    const fileConents = /** @type {HashgraphProto.proto.FileGetContentsResponse.IFileContents} */
