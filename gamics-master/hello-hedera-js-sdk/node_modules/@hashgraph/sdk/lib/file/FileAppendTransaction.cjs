...
class FileAppendTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const append = /** @type {HashgraphProto.proto.IFileAppendTransactionBody} */
    body.fileAppend;
    let contents;
    for (let i = 0; i < bodies.length; i += nodeIds.length) {
      const fileAppend = /** @type {HashgraphProto.proto.IFileAppendTransactionBody} */
      bodies[i].fileAppend;
    ...
    return _Transaction.default._fromProtobufTransactions(new FileAppendTransaction({
      fileId: append.fileID != null ? _FileId.default._fromProtobuf( /** @type {HashgraphProto.proto.IFileID} */
