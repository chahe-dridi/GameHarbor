...
class FileInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const fileGetInfo = /** @type {HashgraphProto.proto.IFileGetInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    ...
    response.fileGetInfo;
    return Promise.resolve(_FileInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.IFileInfo} */info.fileInfo));
  }
