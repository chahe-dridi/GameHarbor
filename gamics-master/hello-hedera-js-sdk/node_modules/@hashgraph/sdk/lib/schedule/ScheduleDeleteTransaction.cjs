...
class ScheduleDeleteTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    const body = bodies[0];
    const scheduleDelete = /** @type {HashgraphProto.proto.IScheduleDeleteTransactionBody} */
    body.scheduleDelete;
    return _Transaction.default._fromProtobufTransactions(new ScheduleDeleteTransaction({
      scheduleId: scheduleDelete.scheduleID != null ? _ScheduleId.default._fromProtobuf( /** @type {HashgraphProto.proto.IScheduleID} */
