...
class ScheduleInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const scheduleGetInfo = /** @type {HashgraphProto.proto.IScheduleGetInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const info = /** @type {HashgraphProto.proto.IScheduleGetInfoResponse} */
    response.scheduleGetInfo;
    return Promise.resolve(_ScheduleInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.IScheduleInfo} */
    info.scheduleInfo));
  }
