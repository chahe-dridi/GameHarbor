...
class ScheduleCreateTransaction extends _Transaction.default {
  ...
  static _fromProtobuf(transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    if (body.scheduleCreate != null) {
      ...
      const scheduleCreateBodyBytes = HashgraphProto.proto.TransactionBody.encode(
      // @ts-ignore
      scheduleCreateBody).finish();
      const signedScheduledCreateTransaction = HashgraphProto.proto.SignedTransaction.encode({
