...
class ContractInfoQuery extends _Query.default {
  ...
  _mapResponseHeader(response) {
    const contractGetInfo = /** @type {HashgraphProto.proto.IContractGetInfoResponse} */
  ...
  _mapResponse(response, nodeAccountId, request) {
    const info = /** @type {HashgraphProto.proto.IContractGetInfoResponse} */
    response.contractGetInfo;
    return Promise.resolve(_ContractInfo.default._fromProtobuf( /** @type {HashgraphProto.proto.ContractGetInfoResponse.IContractInfo} */
    info.contractInfo));
  }
