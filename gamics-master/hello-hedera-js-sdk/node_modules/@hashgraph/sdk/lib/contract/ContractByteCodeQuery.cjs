...
class ContractByteCodeQuery extends _Query.default {
  ...
  static _fromProtobuf(query) {
    const bytecode = /** @type {HashgraphProto.proto.IContractGetBytecodeQuery} */
  ...
  _mapResponseHeader(response) {
    const contractGetBytecodeResponse = /** @type {HashgraphProto.proto.IContractGetBytecodeResponse} */
