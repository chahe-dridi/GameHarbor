...
export default class ContractFunctionResult {
     ...
     * @returns {number}
     */
    getInt16(index?: number | undefined): number;
    /**
     * @param {number} [index]
     * @returns {number}
     */
    getUint16(index?: number | undefined): number;
    /**
     * @param {number} [index]
     * @returns {number}
     */
    getInt24(index?: number | undefined): number;
    /**
     * @param {number} [index]
     * @returns {number}
     */
    getUint24(index?: number | undefined): number;
    /**
     * @param {number} [index]
     * @returns {number}
     */
