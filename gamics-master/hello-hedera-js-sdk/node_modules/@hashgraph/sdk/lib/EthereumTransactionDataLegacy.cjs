...
class EthereumTransactionDataLegacy extends _EthereumTransactionData.default {
  /**
   * @private
   * @param {object} props
...
exports.default = EthereumTransactionDataLegacy;
_Cache.default.setEthereumTransactionDataLegacyFromBytes(bytes => EthereumTransactionDataLegacy.fromBytes(bytes));