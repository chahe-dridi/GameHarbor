...
class EthereumTransactionDataEip2930 extends _EthereumTransactionData.default {
  /**
   * @private
   * @param {object} props
...
exports.default = EthereumTransactionDataEip2930;
_Cache.default.setEthereumTransactionDataEip2930FromBytes(bytes => EthereumTransactionDataEip2930.fromBytes(bytes));